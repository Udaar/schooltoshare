...
@section('content')
    <section class="ifm-white-bg invoice-show-section clearfix info-section ifm-padding-all ifm-padding-md-all ifm-border-light-grey-all">
        ...
        <div class="container-fluid">
            @include('inventory::packings.show_fields')
        </div>
        <a href="{!! route('packings.index') !!}" class="pull-right btn ifm-btn-default ifm-light-grey-bg ifm-grey ifm-border-light-grey-all">Back</a>
    </section>
    ...
    {{-- <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">Packing</span>
            </div>
        </div>
        <div>
            @include('metronic-templates::common.errors')
