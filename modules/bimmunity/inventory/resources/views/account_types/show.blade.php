...
@section('content')
    <section class="ifm-white-bg invoice-show-section clearfix info-section ifm-padding-all ifm-padding-md-all ifm-border-light-grey-all">
        ...
        <div class="container-fluid">
            @include('inventory::account_types.show_fields')
        </div>
        <a href="{!! route('accountTypes.index') !!}" class="pull-right btn ifm-btn-default ifm-light-grey-bg ifm-grey ifm-border-light-grey-all">Back</a>
    </section>
@endsection
