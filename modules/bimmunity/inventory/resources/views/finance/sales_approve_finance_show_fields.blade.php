        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Date Required:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($out_order[0]->date_required)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Date Received:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($out_order[0]->date_received)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
...
<div class="row ifm-margin-md-bottom">
    <div class="col-xs-12 col-md-6">
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Company: <span class="ifm-grey">{!! $out_order[0]->company->name !!}</span></h4>
            </div>
        </div>
    </div>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Status:
                    <span class="ifm-grey">
                        @if($out_order[0]->status == 0)
                            echo "No Action";
                        @elseif($out_order[0]->status == 1)
                            echo "Pending";
                        @elseif($out_order[0]->status == 2)
                            echo "Refused";
                        @elseif($out_order[0]->status == 3)
                            echo "Accepted";
                        @endif
                    </span>
                </h4>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey"> Current Position:
                    <span class="ifm-grey">
                        @if($out_order[0]->element_status == 0)
                            echo "Created";
                        @elseif($out_order[0]->element_status == 1)
                            echo "Purchase";
                        @elseif($out_order[0]->element_status == 2)
                            echo "Finance";
                        @elseif($out_order[0]->element_status == 3)
                            echo "Qc";
                        @elseif($out_order[0]->element_status == 4)
                            echo "Packing";
                        @elseif($out_order[0]->element_status == 5)
                            echo "Returned";
                        @elseif($out_order[0]->element_status == 6)
                            echo "Done";
                        @endif
                    </span>
                </h4>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Created At:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($out_order[0]->created_at)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
...
<div class="row ifm-margin-md-bottom">
    <div class="col-xs-12">
        <textarea class="form-control ifm-border-light-grey-all" rows="6"></textarea>
    </div>
</div>
@endif

@if(isset($out_order_items) && isset($out_order_items[0]))
    <div class="row ifm-margin-md-bottom last-info">
    <div class="col-xs-12 item-col">
        <div class="item-table table-responsive" style="display:none">
            <table class="table table-bordered table-hover text-center">
                ...
                <tbody>
                <?php $counter = 1;?>
                    @foreach($out_order_items as $order_item)
                        <tr>
                                <td>
