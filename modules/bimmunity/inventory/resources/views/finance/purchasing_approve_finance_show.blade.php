        ...
        <section class="ifm-white-bg order-show-section clearfix info-section ifm-padding-all ifm-padding-md-all ifm-border-light-grey-all">
            ...
            <div class="ifm-padding-md-bottom ifm-margin-md-bottom ifm-border-light-grey-bottom clearfix">
                <h3 class="ifm-grey ifm-no-margin-all inline-block uppercase title">
                    ...
                    Order Number {{ $in_order[0]['order_number'] }}
                </h3>
            </div>
            {{-- Errors Div --}}
            <div>
            ...
            <div class="container-fluid">
                @include('inventory::finance.purchasing_approve_finance_show_fields')
            </div>
            <div class="col-xs-12">
                @if(($in_order[0]['element_status'] == 2 && $in_order[0]['status'] != 3) || ($in_order[0]['element_status'] == 1 && $in_order[0]['status'] == 3))
                <form id="approve_form" action="{!! route('finance.finance_action',3) !!}" method="post" class="col-xs-2" >
                    <input type="hidden" name="approve_notes" id="approve_notes">
                    <input type="hidden" name="order_id" value="{{ $in_order[0]['id'] }}">
                ...
                <form id="pending_form" action="{!! route('finance.finance_action',1) !!}" method="post" class="col-xs-2">
                ...
                <form id="refuse_form" action="{!! route('finance.finance_action',2) !!}" method="post" class="col-xs-2">
