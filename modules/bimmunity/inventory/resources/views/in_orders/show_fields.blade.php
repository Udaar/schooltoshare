        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Date Required:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($inOrder->date_required)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Date Received:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($inOrder->date_received)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
...
<div class="row ifm-margin-md-bottom">
    <div class="col-xs-12 col-md-6">
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Company: <span class="ifm-grey">{!! $inOrder->company->name !!}</span></h4>
            </div>
        </div>
    </div>
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Status:
                    <span class="ifm-grey">
                        @if($inOrder->status == 0)
                            echo "No Action";
                        @elseif($inOrder->status == 1)
                            echo "Pending";
                        @elseif($inOrder->status == 2)
                            echo "Refused";
                        @elseif($inOrder->status == 3)
                            echo "Accepted";
                        @endif
                    </span>
                </h4>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey"> Current Position:
                    <span class="ifm-grey">
                        @if($inOrder->element_status == 0)
                            echo "Created";
                        @elseif($inOrder->element_status == 1)
                            echo "Purchase";
                        @elseif($inOrder->element_status == 2)
                            echo "Finance";
                        @elseif($inOrder->element_status == 3)
                            echo "Qc";
                        @elseif($inOrder->element_status == 4)
                            echo "Packing";
                        @elseif($inOrder->element_status == 5)
                            echo "Returned";
                        @elseif($inOrder->element_status == 6)
                            echo "Done";
                        @endif
                    </span>
                </h4>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Created At:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($inOrder->created_at)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
...
@if(($inOrder['element_status'] == 1 && $inOrder['status'] != 3) || ($inOrder['element_status'] > 1 && $inOrder['status'] != 3) || ($inOrder['element_status'] < 1 ))
<div class="row ifm-margin-md-bottom">
    <div class="col-xs-12">
...
@if(isset($order_items) && isset($order_items[0]))
<div class="row ifm-margin-md-bottom">
