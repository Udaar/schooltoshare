        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Date Required:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($outOrder->date_required)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Date Received:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($outOrder->date_received)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
...
<div class="row ifm-margin-md-bottom">
    <div class="col-xs-12 col-md-6">
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Company: <span class="ifm-grey">{!! $outOrder->company->name !!}</span></h4>
            </div>
        </div>
    </div>
                ...
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Status:
                    <span class="ifm-grey">
                        @if($outOrder->status == 0)
                            echo "No Action";
                        @elseif($outOrder->status == 1)
                            echo "Pending";
                        @elseif($outOrder->status == 2)
                            echo "Refused";
                        @elseif($outOrder->status == 3)
                            echo "Accepted";
                        @endif
                    </span>
                </h4>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey"> Current Position:
                    <span class="ifm-grey">
                        @if($outOrder->element_status == 0)
                            echo "Created";
                        @elseif($outOrder->element_status == 1)
                            echo "Purchase";
                        @elseif($outOrder->element_status == 2)
                            echo "Finance";
                        @elseif($outOrder->element_status == 3)
                            echo "Qc";
                        @elseif($outOrder->element_status == 4)
                            echo "Packing";
                        @elseif($outOrder->element_status == 5)
                            echo "Returned";
                        @elseif($outOrder->element_status == 6)
                            echo "Done";
                        @endif
                    </span>
                </h4>
        ...
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="font-lg no-margin bold ifm-weight-400 ifm-grey">Created At:
                    <span class="ifm-grey">
                        {!! Carbon\Carbon::parse($outOrder->created_at)->format('d/m/Y') !!}
                    </span>
                </h4>
            </div>
        </div>
...
@if(($outOrder['element_status'] == 1 && $outOrder['status'] != 3) || ($outOrder['element_status'] > 1 && $outOrder['status'] != 3) || ($outOrder['element_status'] < 1 ))
<div class="row ifm-margin-md-bottom">
    <div class="col-xs-12">
...
{{-- <div class="form-group">
    ...
    <p>{!! $outOrder->order_number !!}</p>
</div>

<!-- Date Required Field -->
<div class="form-group">
    {!! Form::label('date_required', 'Date Required:') !!}
    <p>{!! $outOrder->date_required !!}</p>
</div>

<!-- Date Received Field -->
<div class="form-group">
    {!! Form::label('date_received', 'Date Received:') !!}
    <p>{!! $outOrder->date_received !!}</p>
</div>

<!-- Company Id Field -->
<div class="form-group">
    {!! Form::label('company_id', 'Company :') !!}
    <p>{!! $outOrder->company->name !!}</p>
</div>

<!-- Finance Approved By Field -->
<div class="form-group">
    {!! Form::label('finance_approved_by', 'Finance Approved By:') !!}
    <p>{!! $outOrder->finance_approved_by !!}</p>
</div>

<!-- Finance Approved Date Field -->
<div class="form-group">
    {!! Form::label('finance_approved_date', 'Finance Approved Date:') !!}
    <p>{!! $outOrder->finance_approved_date !!}</p>
</div>
...
<div class="form-group">
    ...
    <p>{!! $outOrder->user->name !!}</p>
</div>

<!-- Created At Field -->
<div class="form-group">
    {!! Form::label('created_at', 'Created At:') !!}
    <p>{!! $outOrder->created_at !!}</p>
</div> --}}
