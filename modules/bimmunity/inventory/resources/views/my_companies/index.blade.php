...
<section class="my-company-section ifm-padding-md-all ifm-white-bg ifm-border-light-grey-all">
        
    <!-- My Company Title Bar -->
    <div class="ifm-padding-md-bottom ifm-margin-sm-bottom ifm-border-light-grey-bottom clearfix">
        ...
        <a href="{!! route('myCompanies.create') !!}" class="btn ifm-btn-green ifm-grey-bg ifm-white ifm-absolute-right" style="top:19px;right:36px"><i class="fa fa-plus"></i> Add</a>
    </div>
    <!-- /My Company Title Bar -->
    ...
    <div class="row">
        ...
        <div class="ifm-padding-sm-all">
            @include('inventory::my_companies.table')
        </div>
    </div>
    <!-- /My Company Table -->
