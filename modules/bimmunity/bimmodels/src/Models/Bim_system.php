 ...
 */
class Bim_system extends Model
{
    use SoftDeletes;

    public $table = 'bim_systems';
    ...
    public function bimmodel(){
        return $this->hasMany('Bimmunity\Bimmodels\Models\Bim_model','discipline_code','code');
    }
    public function system(){
        return $this->belongsTo('Bimmunity\Bimmodels\Models\Bim_system','parent_id','id');
    }
