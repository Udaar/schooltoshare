							...
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									...
									@else
										...
										<a href="/register" class="button button-3d dark-bg nomargin"><i class="fa fa-pencil"></i> Register</a>
									@endif
								</div>
							</div>
						</div>
		...
		<section id="content">
			<div class="content-wrap">
                <div class="container-fluid">
                    <h3 class="bold name-location">{{$building->name}} , {{$building->address}}</h3>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="right">
                                ...
                                <div class="property-reviews">
                                    <div class="mt-comments">
                                        @foreach($building->rates as $rate)
                                ...
                                @if(Auth::check())
                                <a href="/follow/{{$building->id}}" id="quick-contact-form-submit" name="quick-contact-form-submit" class="button button-small nomargin" value="submit">Follow Building</a>
                                @else
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="facilities">
                                ...
                                <div class="row">
                                    @if(count($building->facilities)>0)
                                ...
                                <div class="pricing-content-1">
                                    <div class="row">
                                        `@foreach($building->propertis as $property)
                                            <div class="col-md-3">
                                                <div class="price-column-container border-active">
                                                    <div class="price-table-head bg-blue">
                                                        <h2 class="no-margin">{{$property->name}}</h2>
                                                    </div>
                                                    <div class="arrow-down border-top-blue"></div>
                                                    <div class="price-table-pricing">
                                                        <h3>
                                                            <span class="price-sign"></span>{{$property->value}}</h3>
                            ...
                            <div class="events">
                                ...
                                <div class="row">
                                @if(count($building->events)>0)
                                        @foreach($building->events as $event)
                                            <div class="col-lg-2">
                                                <div class="mt-element-ribbon bg-grey-steel">
                                                    <div class="ribbon ribbon-color-success uppercase">{{$event->name}}</div>
                                                    <p class="ribbon-content">{{$event->description}}</p>
                                                </div>
                                            </div>
                                        @endforeach
                                @else
