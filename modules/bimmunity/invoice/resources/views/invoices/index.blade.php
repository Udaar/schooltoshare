...
<section class="invoices-section ifm-padding-md-all ifm-white-bg ifm-border-light-grey-all">
    ...
    <div class="ifm-padding-md-bottom ifm-margin-sm-bottom ifm-border-light-grey-bottom clearfix">
        ...
        <a href="{!! route('invoices.create') !!}" class="btn ifm-btn-green ifm-grey-bg ifm-white ifm-absolute-right add-btn" style="top:19px;right:36px"><i class="fa fa-plus"></i> Add</a>
    </div>
	<!-- /Invoices Title Bar -->
    ...
    <div class="row">
        ...
        <div class="ifm-padding-sm-all">
            @include('bimmunity/invoice::invoices.table')
        </div>
