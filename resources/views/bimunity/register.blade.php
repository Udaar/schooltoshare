...
<head>
	...
	<link rel="stylesheet" href="/bimunity/css/register.css">
			...
			<div class="content-wrap">
				<div class="container">
                    <div class="sign-up-wrap text-center">
                        ...
                        <div class="bimm-who">
                            <p class="lead">
                                <span>WELCOME TO BIMMUNITY:</span> an integrated platform for managing the built environment
                            </p>
                            <h2 class="bold text-uppercase">who are you ?</h2>
                        </div>
                        <div class="account-types">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="account-type">
                                        <span class="prop-account text-uppercase">property manager</span>
                                    </div>
                                    <a href="#" class="sign-in text-capitalize">signup here</a>
                                </div>
                                <div class="col-lg-4">
                                    <div class="account-type">
                                        <span class="facility-account text-uppercase">facility manager</span>
                                    </div>
                                    <a href="#" class="sign-in text-capitalize">signup here</a>
                                </div>
                                <div class="col-lg-4">
                                    <div class="account-type">
                                        <span class="sp-account text-uppercase">serv. provider / vendor</span>
                                    </div>
                                    <a href="#" class="sign-in text-capitalize">signup here</a>
                                </div>
                            </div>
