...
<head>
	...
	<link rel="stylesheet" href="/bimunity/css/main.css" type="text/css" />
	<link rel="stylesheet" href="/bimunity/css/style.css" type="text/css" />
	<link rel="stylesheet" href="/metronic/assets/global/plugins/simple-line-icons/simple-line-icons.css">
    <style>
		:root:root:root .jwplayer.jw-flag-aspect-mode{
            height: 100%!important;
        }
        :root:root:root .jw-error .jw-preview, :root:root:root .jwplayer .jw-preview{
            background-size: cover;
        }
        :root:root:root .jwplayer{
...
<body class="stretched">
				...
				<div class="container clearfix">
					...
					<nav id="primary-menu">
						<ul>
							...
							@if(\Auth::user())
								<li><a href="/login" class="dashboard" style="color:#FFFFFF;padding-right:15px;margin-left:15px;background-color:#68c0d8"><i class="icon-speedometer" style="line-height:65.5px"></i> Dashboard</a></li>
							@else
								<li class="dropdown">
									<a href="#" class="dropdown-toggle login" style="color:#FFFFFF;padding-right:15px;margin-left:15px;background-color:#68c0d8" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-power-off" style="line-height:65.5px"></i> Login <span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a href="/login" class="nomargin"><i class="icon-login"></i> Login</a></li>
										<li><a href="/login#register" class="nomargin"><i class="fa fa-pencil"></i> Register</a></li>
										<li><a href="/guest" class="nomargin"><i class="fa fa-user"></i> Guest</a></li>
									</ul>
								</li>
							@endif
						</ul>
		...
		<section id="content">
			<div class="content-wrap">
				...
				<section id="logic" class="logic">
					<div class="container-fluid">
						<div class="row clearfix" style="background-color:#d8e4f0">
							<div class="col-md-6 eq-child relative dark-bg" style="padding:0">
								<img src="/bimunity/images/logic.png" alt="" width="60%" style="position:absolute;top:50%;left:50%;transform:translate(-50%, -50%)">
							</div>
						...
						<div class="row clearfix" style="background-color:#d8e4f0">
							...
							<div class="col-md-6 eq-child relative dark-bg hidden-sm hidden-xs">
								<div class="img-container">
									<img src="/bimunity/images/platforms.png" class="img-responsive" alt="">
								</div>
							</div>
						</div>
					</div>
				...
				<section id="users" class="users">
					<div class="container-fluid">
						<div class="row clearfix" style="background-color:#d8e4f0">
							<div class="col-md-6 eq-child relative dark-bg hidden-sm hidden-xs">
								<div class="img-container">
									<img src="/bimunity/images/users.png" class="img-responsive" alt="">
								</div>
							</div>
							<div class="col-md-6 eq-parent relative padding-50-all">
								<div class="text-center">
				...
				<section id="contact" class="contact">
					...
					<h3 class="uppercase text-center padding-50-all">Contact US</h3>
					<div class="container">
						<div class="postcontent nobottommargin" style="width:100%">

							<div id="contact-form-result" data-notify-type="success" data-notify-msg="<i class=icon-ok-sign></i> Message Sent Successfully!"></div>

							{!! Form::open(['route' => 'sendemail.store']) !!}
								...
								<div class="col-md-6 padding-0-left">
									<label for="template-contactform-name">Name <small>*</small></label>
									{!! Form::text('name', null, ['class' => 'sm-form-control required','id'=>'template-contactform-name','required'=>'required']) !!}
									<!--<input type="text" id="template-contactform-name" name="template-contactform-name" value="" class="sm-form-control required" />-->
								</div>

								<div class="col-md-6 padding-0-left padding-0-right">
									<label for="template-contactform-email">Email <small>*</small></label>
									{!! Form::text('email', null, ['class' => 'required email sm-form-control','id'=>'template-contactform-email','required'=>'required']) !!}
								...
								<div class="col_full">
									<label for="template-contactform-message">Message <small>*</small></label>
									 {!! Form::textarea('Message', null, ['class' => 'form-control','id'=>'template-contactform-message','rows'=>'6' ,'cols'=>'30','required'=>'required']) !!}
								...
								<div class="col_full">
									<button class="button button-3d nomargin button-blue" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Send Message</button>
								</div>
	...
	<script>
		...
		jwplayer("myvideo5").setup({
            file: "/jwplayer-7.11.0/BIMMUNITY_UDAAR_PROMOTIONAL VIDEO.mp4",
            image: "/bimunity/images/poster.png",
            width: "100%",
            aspectratio: "4:3"
        });
	</script>
