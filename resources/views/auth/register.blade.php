...
<head>
    ...
    <link href="metronic/assets/pages/css/login-2.min.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
    <a href="{{ url('/') }}">
        <img src="metronic/assets/pages/img/logo-big-white.png" style="height: 17px;" alt=""/> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <form class="login-form" method="post" action="{!! url('/register') !!}">
        ...
        <!-- /.col -->
        <div class="form-group ">
            <button type="submit" class="btn red btn-block btn-flat">Register</button>
        </div>
        <!-- /.col -->
    </form>
