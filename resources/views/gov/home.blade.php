    ...
    <section class="pm-dashboard">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <a class="dashboard-stat dashboard-stat-v2 second-color" >
                        <div class="visual">
                ...
                <div class="col-md-3 col-sm-6">
                    <a class="dashboard-stat dashboard-stat-v2 fourth-color" href="/requests">
                        ...
                        <div class="details">
                            <div class="number"> +
                                <span data-counter="counterup" data-value="{{count($requests)}}"></span> </div>
                        ...
                        <div class="panel-body">
                            <div style="position:relative;padding:0">
                                <table class="table table-striped table-bordered table-hover " width="100%" id="sample_1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-capitalize">School Name</td>
                                            <td class="text-capitalize">Schools Location</td>
                                            <td class="text-capitalize">Bed Room</td>
                                            <td class="text-capitalize">Urgent</td>        
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
@push('scripts')
    ...
    createPieChart(['reissuedTickets', 'ticketstatus', 'ticketsPerType'
        ...
        $(function(){
            ...
            function initialize() {
                center={lat: 27.193116, lng: 31.183815};
				positions=[];
